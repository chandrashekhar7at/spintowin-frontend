...
const Signup = () => {
    ...
    const handleSignupFormSubmit = async (e) => {
        ...
        try {
            ...
            const result = await axios.post(`${BaseUrl}/api/signup`,{phone,password},{
    ...
    return (
        <div className="flex-col px-5 mt-[-100px] min-h-screen flex justify-center items-center bg-gradient-to-r from-indigo-500 via-purple-500 to-pink-500">
            {/* 3D Card */}
            <form onSubmit={handleSignupFormSubmit} className="relative w-full max-w-md p-8 bg-white bg-opacity-90 rounded-lg shadow-2xl transform perspective-3d hover:translate-z-10 hover:shadow-2xl transition-all duration-500">
